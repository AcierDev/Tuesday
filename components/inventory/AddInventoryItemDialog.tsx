...
export default function AddItemDialog({ showAddItemDialog, setShowAddItemDialog, addItem }: AddItemDialogProps) {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setNewItem({ ...newItem, countType: e.target.value })}
                className="bg-input dark:bg-gray-700"
              />
            </div>
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value: CountFrequency) => setNewItem({ ...newItem, countFrequency: value })}
              >
                <SelectTrigger id="item-count-frequency" className="bg-input dark:bg-gray-700">
