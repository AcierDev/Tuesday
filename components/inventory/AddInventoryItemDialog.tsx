...
export default function AddItemDialog(
  { showAddItemDialog, setShowAddItemDialog, addItem }: AddItemDialogProps,
) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (
      newItem.name && newItem.quantity !== undefined &&
      newItem.restockQuantity !== undefined && newItem.countType &&
      newItem.countFrequency && newItem.category
    ) {
