...
export function GluingActivityChart({ 
  ...
  const [selectedDay, setSelectedDay] = useState<GluingActivityData | null>(null)
    ...
    <>
      ...
      <Dialog open={!!selectedDay} onOpenChange={() => setSelectedDay(null)}>
        <DialogContent className="sm:max-w-[800px] bg-background text-foreground dark:bg-gray-800">
          <DialogHeader>
            <DialogTitle className="text-foreground dark:text-gray-100">Gluing Activity for {selectedDay?.date}</DialogTitle>
          </DialogHeader>
            ...
            <Table>
              <TableHeader className="sticky top-0 z-10">
                <TableRow className="bg-muted dark:bg-gray-900 rounded-t-md">
                  ...
                  <TableHead className="text-muted-foreground dark:text-gray-300">Completed Date</TableHead>
                  <TableHead className="text-muted-foreground dark:text-gray-300 last:rounded-tr-md">Glued By</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
