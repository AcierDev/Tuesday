      ...
      <DialogContent className="sm:max-w-[600px] dark:bg-gray-900">
        ...
        <Tabs className="w-full" value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="item">
            <Card className="border-none dark:bg-gray-800 shadow-card">
              <CardContent className="space-y-4 pt-4">
                ...
                {editingItem?.values.map((value) => (
                  ...
                  >
                    ...
                    <Input
                      className="col-span-3 dark:bg-gray-700 dark:border-none"
                      id={value.columnName}
                      value={value.text || ""}
                      onChange={(e) =>
            ...
            <Card className="border-none dark:bg-gray-800 shadow-card">
              <CardContent className="space-y-4 pt-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right" htmlFor="receipt_id">
                    Receipt ID
                  </Label>
                  <Input
                    className="col-span-3 dark:bg-gray-700 dark:border-none"
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right" htmlFor="buyer_email">
                    Buyer Email
                  </Label>
                  <Input
                    className="col-span-3 dark:bg-gray-700 dark:border-none"
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right" htmlFor="first_line">
                    Address
                  </Label>
                  <Input
                    className="col-span-3 dark:bg-gray-700 dark:border-none"
                    ...
                    onChange={(e) =>
                      updateReceiptValue("street1", e.target.value)
                    }
                  />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateReceiptValue("state", e.target.value)
                    }
                  />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateReceiptValue("postalCode", e.target.value)
                    }
                  />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right" htmlFor="tracking">
                    Tracking Number
                  </Label>
                  <Input
                    className="col-span-3 dark:bg-gray-700 dark:border-none"
