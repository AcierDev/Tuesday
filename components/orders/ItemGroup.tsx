...
import { Board, ColumnTitles, ColumnTypes, Group, Item, ItemStatus } from "../../typings/types"
...
export function ItemGroupSection({
  ...
  return (
    <div className="mb-6 bg-white dark:bg-gray-900 rounded-lg" style={{"contain": "paint"}}>
      <div className={cn(
        `w-full p-4`,
        `text-${STATUS_COLORS[group.title]} dark:text-${STATUS_COLORS[group.title]}`,
