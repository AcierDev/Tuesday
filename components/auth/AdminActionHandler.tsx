...
export type AdminActionHandlerProps = {
  ...
  children: (props: { onClick: () => Promise<void>, disabled: boolean }) => ReactNode
}
    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[425px] dark:bg-gray-800">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => onOpenChange(false)} className="dark:bg-gray-700 dark:text-white">
              Cancel
            </Button>
            <Button onClick={handleConfirm} disabled={isLoading} className="dark:bg-blue-600 dark:hover:bg-blue-700">
              Confirm
            </Button>
          </DialogFooter>
        </DialogContent>
