...
export const itemSortFuncs: ItemSortFuncs = {
  [ColumnTitles.Customer_Name]: (items, ascending) =>
    [
      ...
      const aName = a.values.find(
        (v) => v.columnName === ColumnTitles.Customer_Name,
      )?.text || "";
      const bName = b.values.find(
        (v) => v.columnName === ColumnTitles.Customer_Name,
      )?.text || "";
      return ascending
  ...
  [ColumnTitles.Design]: (items, ascending) =>
    [
      ...
      const aDesign = a.values.find(
        (v) => v.columnName === ColumnTitles.Design,
      )?.text || "";
      const bDesign = b.values.find(
        (v) => v.columnName === ColumnTitles.Design,
      )?.text || "";
      return ascending
  ...
  [ColumnTitles.Size]: (items, ascending) =>
    [
      ...
      const aSize = a.values.find(
        (v) => v.columnName === ColumnTitles.Size,
      )?.text || "";
      const bSize = b.values.find(
        (v) => v.columnName === ColumnTitles.Size,
      )?.text || "";
      return ascending
  ...
  [ColumnTitles.Painted]: (items, ascending) =>
    [
      ...
      const aStatus = a.values.find(
        (v) => v.columnName === ColumnTitles.Painted,
      )?.text || "";
      const bStatus = b.values.find(
        (v) => v.columnName === ColumnTitles.Painted,
      )?.text || "";
      return ascending
  ...
  [ColumnTitles.Notes]: (items, ascending) =>
    [
      ...
      const aNotes = a.values.find(
        (v) => v.columnName === ColumnTitles.Notes,
      )?.text || "";
      const bNotes = b.values.find(
        (v) => v.columnName === ColumnTitles.Notes,
      )?.text || "";
      return ascending
  ...
  [ColumnTitles.Rating]: (items, ascending) =>
    [
      ...
      const aRating = Number(
        a.values.find(
          (v) => v.columnName === ColumnTitles.Rating,
        )?.text || "0",
      );
  ...
  [ColumnTitles.Due]: (items, ascending) =>
    [
      ...
      const aDateString = a.values.find((v) =>
        v.columnName === ColumnTitles.Due
      )?.text || "";
      const bDateString =
        b.values.find((v) => v.columnName === ColumnTitles.Due)?.text || "";
      const aDate = aDateString ? parseISO(aDateString) : new Date(0);
      const bDate = bDateString ? parseISO(bDateString) : new Date(0);
