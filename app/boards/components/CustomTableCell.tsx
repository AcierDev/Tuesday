...
import { Item, ColumnValue, ColumnTypes, ProgressStatus, Board } from '../../typings/types'
import { boardConfig } from '../../config/boardconfig'
import { automatron } from '../../config/automatron'
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover"
import { format } from 'date-fns'
import { getCellClassName, getDueBadge } from '../../utils/functions'
...
export default function CustomTableCell({ item, columnValue, board, onUpdate, isNameColumn = false }: CustomTableCellProps) {
    ...
    case ColumnTypes.Date:
      return (
        <div className="flex items-center space-x-2">
          ...
          {date && getDueBadge(date.toISOString())}
        </div>
      )
