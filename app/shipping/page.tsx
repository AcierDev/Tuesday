...
import { type Board, type Item, ShippingStatus } from "@/typings/types";
...
async function fetchTrackingData(
  ...
  try {
    ...
    const referenceNumbers = shipment?.referenceNumber?.map((ref: any) =>
      ref.number
    ) || [];
...
export default function ShippingPage() {
  ...
  useEffect(() => {
    const filtered = items.filter((item) =>
      ...
      item.shippingDetails?.name.toLowerCase().includes(
        searchTerm.toLowerCase(),
      ) ||
          ...
          try {
            ...
            return {
              ...
              trackingInfo: {
                ...
                serviceDescription: trackingData.trackingInfo
                  ?.serviceDescription,
