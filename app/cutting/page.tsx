...
import { format, startOfDay, subDays, startOfWeek, endOfWeek, isSameWeek } from "date-fns"
    ...
    <div className="container mx-auto p-4 space-y-8">
      <div className="grid gap-4 md:grid-cols-5">
        <div className="space-y-4">
          <StatCard title="Current Board Inventory" value={boardsInventory?.quantity || 0} />
          <StatCard title="Restock Quantity" value={boardsInventory?.restockQuantity || 0} />
          <StatCard 
            title="Last Count Date" 
            value={boardsInventory?.countHistory.length
              ? format(new Date(boardsInventory.countHistory[boardsInventory.countHistory.length - 1]!.timestamp), "MM/dd/yyyy")
              : "N/A"
            }
          />
        </div>
