...
const TEMPLATES = [
  { id: 1, name: "Drywall Anchors", src: "/images/drywall-anchors.png", orientation: "landscape", type: "image" },
  { id: 2, name: "Hanging Examples", src: "/images/hanging-examples.png", orientation: "portrait", type: "image" },
  { id: 3, name: "2 Boxes", src: "/pdf/2-boxes.pdf", orientation: "portrait", type: "pdf" },
  { id: 4, name: "2 Panels", src: "/pdf/2-panels.pdf", orientation: "portrait", type: "pdf" },
  { id: 5, name: "3 Boxes", src: "/pdf/3-boxes.pdf", orientation: "portrait", type: "pdf" },
  { id: 6, name: "3 Panels", src: "/pdf/3-panels.pdf", orientation: "portrait", type: "pdf" },
  { id: 7, name: "Fragile Stickers", src: "/pdf/fragile-stickers.pdf", orientation: "portrait", type: "pdf" },
]
  ...
  return (
    <Card className="w-full max-w-md mx-auto dark:bg-gray-800">
      ...
      <CardFooter className="flex justify-center">
        <Button onClick={handlePrint} disabled={selectedTemplateData?.type === 'pdf' && !pdfLoaded}>
          <Printer className="mr-2 h-4 w-4" />
          Print High-Quality {selectedTemplateData?.type === 'pdf' ? 'PDF' : '4" x 6" Label'}
        </Button>
      </CardFooter>
      ...
      <iframe ref={iframeRef} style={{ display: 'none' }} title="PDF Print Frame" />
    </Card>
  )
}